	...
	<u-popup :show="show" mode="center" @close="close" @open="open" :closeOnClickOverlay="false" :round="16"
      ...
      <view class="form-item form-item-bg">
        ...
        <view class="form-item-content">
          <u--input class="account-input" type="password" placeholder="请输入原资金密码" border="none" v-model="form.oldPassword">
          </u--input>
        </view>
      </view>
      <view class="form-item form-item-bg">
        ...
        <view class="form-item-content">
          <u--input class="account-input" type="password" placeholder="请输入新资金密码" border="none" v-model="form.password">
          </u--input>
        </view>
      </view>
      <view class="form-item form-item-bg">
        ...
        <view class="form-item-content">
          <u--input class="account-input" type="password" placeholder="请输入新资金密码" border="none" v-model="form.confirmPassword">
          </u--input>
        </view>
      </view>
    </view>
